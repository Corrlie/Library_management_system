...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCatalogue->setCheckable(true);
        ...
        actionLibraries->setCheckable(true);
        ...
        actionReaders->setCheckable(true);
        ...
        actionBorrowings->setCheckable(true);
        ...
        actionEmployees->setCheckable(true);
